...
The replicated Figure 3 from original report by @EC_Report_2024 is shown below, followed by the research design choices and assumptions in @sec-research_design_assumptions, documentation of the replication steps in @sec-replication_steps, a detailed results comparison in @sec-results, and concluding remarks in @sec-conclusion.
